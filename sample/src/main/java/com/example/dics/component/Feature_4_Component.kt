...
class Feature_4_Component(val name: String) : ActivityDiComponent {

    class Factory : DiComponentWithKeyFactory<Feature_4_Component, Feature4ComponentKey> {
        override fun createComponent(provider: DiComponentProvider, componentKey: Feature4ComponentKey): Feature_4_Component {
            return Feature_4_Component(componentKey.name)
        }
    }

    data class Feature4ComponentKey(val name: String) : ComponentKey<Feature_4_Component>(Feature_4_Component::class)
}
